...
object Perlin: Noise {
    ...
    override fun jitter(point: Vec4, scale: Double): Vec4 = Vec4.point(
        point.x + noise(point.x, point.y, point.z) * scale,
        point.y + noise(point.x, point.y, point.z + 1) * scale,
        point.z + noise(point.x, point.y, point.z + 1) * scale,
    )
