...
class Vec4Test {
    ...
    fun `Adding two tuples` () {
        val a1 = Vec4.point(3, -2, 5)
        val a2 = Vec4.vector(-2, 3, 1)
        assertThatVec4(a1 + a2)
            .isEqualTo(Vec4.point(1, 1, 6))
    }

    @Test
    fun `Substracting two points` () {
        val p1 = Vec4.point(3, 2, 1)
        val p2 = Vec4.point(5, 6, 7)
        assertThatVec4(p1 - p2)
            .isEqualTo(Vec4.vector(-2, -4, -6))
    }

    @Test
    fun `Substracting a vector from a point` () {
        val p = Vec4.point(3, 2, 1)
        val v = Vec4.vector(5, 6, 7)
        assertThatVec4(p - v)
            .isEqualTo(Vec4.point(-2, -4, -6))
    }

    @Test
    fun `Substracting two vectors` () {
        val v1 = Vec4.vector(3, 2, 1)
        val v2 = Vec4.vector(5, 6, 7)
    ...
    fun `Subtracting a vector from the zero vector` () {
        val zero = Vec4.vector(0, 0, 0)
        val v = Vec4.vector(1, -2, 3)
        assertThatVec4(zero - v)
            .isEqualTo(Vec4.vector(-1, 2, -3))
    }
    ...
    fun `Multiplying a tuple by a scalar` () {
        ...
        assertThatVec4(a * 3.5)
            .isEqualTo(Vec4.tuple(3.5, -7, 10.5, -14))
    }
    ...
    fun ` Multiplying a tuple by a fraction` () {
        ...
        assertThatVec4(a * 0.5)
            .isEqualTo(Vec4.tuple(0.5, -1, 1.5, -2))
    }
    ...
    fun `Normalizing vector(4, 0, 0) gives (1, 0, 0)` () {
        val v = Vec4.vector(4, 0, 0)
        assertThatVec4(v.normalize())
            .isEqualTo(Vec4.vector(1, 0, 0))
    }
    ...
    fun `Normalizing vector(1, 2, 3)` () {
        val v = Vec4.vector(1, 2, 3)
        assertThatVec4(v.normalize())
            .isEqualTo(Vec4.vector(0.26726, 0.53452, 0.80178))
    }
    ...
    fun `The dot product of two tuples` () {
        val a = Vec4.vector(1, 2, 3)
        val b = Vec4.vector(2, 3, 4)
        val dot = a dot b
